                            ...
                            <div className="card shadow">
                                <div className="card-body" style={{ width: "470px", height: !this.state.isSignedIn ? '530px' : '480px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                    ...
                                    <form onSubmit={this.handleLogin}>
                                        ...
                                        <div className="text-center"><button type="submit" className="btn btn-dark" style={{ width: "100%", marginTop: "13px" }} onClick={this.handleLogin}>{!this.state.isSignedIn ? "Sign Up" : "Login"}</button></div>
                                    </form>
                                    ...
                                    {!this.state.forgot && this.state.isSignedIn && <button className='btn btn-link' style={{ padding: "0px", marginBottom: "7px", marginTop: "7px", textDecoration: "none" }} onClick={this.forgotpass}>Forgot Password?</button>}
